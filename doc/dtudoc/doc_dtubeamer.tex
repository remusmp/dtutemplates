...
\frame[bgfilename=dtu_bg_fiber, dtuwhitelogo]{
	Jorrit, add here the address box code!
}

\frame[bgfilename=dtu_bg_nano, dtuwhitelogo]{
	Jorrit, add here the address box code!
}

\frame[bgfilename=dtu_bg_pink, dtuwhitelogo]{
	Jorrit, add here the address box code!
}
...
\frame{
	\frametitle[allowframebreaks]{Release History}
	\begin{block}{v1.04}
		\begin{itemize}
			\item Fonts options;
		\end{itemize}
