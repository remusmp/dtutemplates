...
\dtucoverThreeTiles[][tex_dtu_logo] % make the title page background
\dtucoverTitleText[This report has a subtitle]{The Main Title of This Work}{Mag. Thesis}{Navn Navnesen \\ Special Report No. XXX \\ \monthname{} \the\year}
...
\AtEndDocument{\dtucoverBackMatter[\addInfo][\blindtext][\addaddInfo]}
