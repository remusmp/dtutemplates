...
%
\immediate\write18{rm doc_dtucover_adm.tex}
\immediate\write18{del doc_dtucover_adm.tex}
%
...
\end{document}
\end{filecontents}
\immediate\write18{pdflatex doc_dtucover_adm.tex}
\immediate\write18{pdflatex doc_dtucover_adm.tex}
%
%
\immediate\write18{rm doc_dtucover_mek_col_img.tex}
\immediate\write18{del doc_dtucover_mek_col_img.tex}
%
...
\end{document}
\end{filecontents}
\immediate\write18{pdflatex doc_dtucover_mek_col_img.tex}
\immediate\write18{pdflatex doc_dtucover_mek_col_img.tex}
%
