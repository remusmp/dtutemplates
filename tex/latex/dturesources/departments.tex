...
% Last update Fri Apr 23 14:05:23 2010 Tobias Pyndt Steinmann
%
% Changelog
...
%
\ifthenelse{\isundefined{\makeDepartmentInfo}}{%
	\newcommand\makeDepartmentInfo[7]{%
		\def\@departmentcmd{\csname department@#2\endcsname}
		\createDepartment{#2}
		\ifthenelse{\equal{#3}{\@empty}}{%
			\expandafter\def\csname namelogo#1@\@departmentcmd\endcsname{\csname namelogo#1@\department@admin\endcsname}%
		}{%
			\expandafter\def\csname namelogo#1@\@departmentcmd\endcsname{\setDepartmentNameLogo{#3}}%
		}%
		\ifthenelse{\equal{#4}{\@empty}}{%
			\expandafter\def\csname deplogo#1@\@departmentcmd\endcsname{\csname deplogo#1@\department@admin\endcsname}%
		}{%
...
\makeDepartmentInfo{danish} {business}{}{tex_dtu_business_a}{tex_dtu_frise}{DTU Business}{Executive School of Business}%
\makeDepartmentInfo{english}{business}{}{tex_dtu_business_a_uk}{tex_dtu_frise}{DTU Business}{DTU Executive School of Business}%

\makeDepartmentInfo{danish} {byg}{tex_byg_dk}{tex_dtu_byg_a}{tex_dtu_byg_frise}{DTU Byg}{Institut for Byggeri og Anl\ae g}%
\makeDepartmentInfo{english}{byg}{tex_byg_uk}{tex_dtu_byg_a_uk}{tex_dtu_byg_frise}{DTU Civil Engeneering}{Department of Civil Enginnering}%

\makeDepartmentInfo{danish} {cen}{tex_cen_dk}{tex_dtu_cen_a}{tex_dtu_frise}{DTU Cen}{Center for Elektronnanoskopi}%
\makeDepartmentInfo{english}{cen}{tex_cen_uk}{tex_dtu_cen_a_uk}{tex_dtu_frise}{DTU Cen}{Center for Electron Nanoscopy}%

\makeDepartmentInfo{danish} {danchip}{tex_danchip_dk}{tex_dtu_danchip_a}{tex_dtu_frise}{DTU Danchip}{Nationalt center for Mikro- og Nanofabrikation}%
\makeDepartmentInfo{english}{danchip}{tex_danchip_uk}{tex_dtu_danchip_uk_a}{tex_dtu_frise}{DTU Danchip}{Danchip}%
...
\makeDepartmentInfo{danish} {energikonvertering}{tex_energikonvertering_dk}{tex_dtu_energikonvertering_a}{tex_dtu_energikonvertering_frise}{DTU Energikonvertering}{Institut for Energikonvertering og -lagring}%
\makeDepartmentInfo{english}{energikonvertering}{tex_energikonvertering_uk}{tex_dtu_energikonvertering_a_uk}{tex_dtu_energikonvertering_frise}{DTU Energy Conversion}{Department of Energy Conversion and Storage}%


\makeDepartmentInfo{danish} {fodevareinstituttet}{tex_fodevareinstituttet_dk}{tex_dtu_fdevareinstituttet_a}{tex_dtu_frise}{DTU F\o devareinstituttet}{}%
\makeDepartmentInfo{english}{fodevareinstituttet}{tex_fodevareinstituttet_uk}{tex_dtu_fdevareinstituttet_a_uk}{tex_dtu_frise}{National Food Institute}{}%
...
\makeDepartmentInfo{danish} {informatik}{tex_informatik_dk}{tex_dtu_informatik_a}{tex_dtu_frise}{DTU Informatik}{Institut for Informatik og Matematisk Modellering}%
\makeDepartmentInfo{english}{informatik}{tex_informatik_uk}{tex_dtu_informatics_a_uk}{tex_dtu_frise}{DTU Informatics}{Department of Informatics and Mathematical Modelling}%
...
\makeDepartmentInfo{danish} {kemiteknik}{tex_kemiteknik_dk}{tex_dtu_kemiteknik_a}{tex_dtu_frise}{DTU Kemiteknik}{Institut for Kemiteknik}%
\makeDepartmentInfo{english}{kemiteknik}{tex_kemiteknik_uk}{tex_dtu_kemiteknik_a_uk}{tex_dtu_frise}{DTU Chemical Engineering}{Department of Chemical and Biochemical Engineering}%

\makeDepartmentInfo{danish} {management}{tex_management_dk}{tex_dtu_management_a}{tex_dtu_frise}{DTU Management}{Institut for Planl\ae gning, Innovation og Ledelse}%
...
\makeDepartmentInfo{danish} {matematik}{tex_matematik_dk}{tex_dtu_matematik_a}{tex_dtu_frise}{DTU Matematik}{Institut for Matematik}%
\makeDepartmentInfo{english}{matematik}{tex_matematik_uk}{tex_dtu_matematik_a_uk}{tex_dtu_frise}{DTU Mathematics}{Department of Mathematics}%
...
\makeDepartmentInfo{danish} {miljo}{tex_miljo_dk}{tex_dtu_milj_a}{tex_dtu_miljoe_frise}{DTU Milj\o}{Institut for Vand og Miljøteknologi}%
...
\makeDepartmentInfo{danish} {nutech}{tex_nutech_dk}{tex_dtu_nutech_a}{tex_dtu_frise}{DTU Nutech}{Center for Nukleare Teknologier}%
\makeDepartmentInfo{english}{nutech}{tex_nutech_uk}{tex_dtu_nutech_a_uk}{tex_dtu_frise}{DTU Nutech}{Center for Nuclear Technologies}%
...
\makeDepartmentInfo{danish} {space}{tex_space_dk}{tex_dtu_space_a}{tex_dtu_space_frise}{DTU Space}{Institut for Rumforskning og -teknologi}%
...
\makeDepartmentInfo{english}{vaterinaerinstituttet}{tex_veterinaertinstituttet_uk}{tex_dtu_veterinerinstituttet_a_uk}{tex_dtu_vet_frise}{National Veterinary Institute}{National Veterinary Institute}%

\makeDepartmentInfo{danish} {vindenergi}{tex_vindenergi_dk}{tex_dtu_vindenergi_a}{tex_dtu_frise}{DTU Vindenergi}{Institut for Vindenergi}%
\makeDepartmentInfo{english}{vindenergi}{tex_vindenergi_uk}{tex_dtu_vindenergi_a_uk}{tex_dtu_frise}{DTU Wind Energy}{Department of Wind Energy}%


\makeDepartmentInfo{danish} {food}{tex_fodevareinstituttet_dk}{tex_dtu_fdevareinstituttet_a}{tex_dtu_frise}{DTU Veterin\ae rinstituttet}{F\o devareinstituttet}%
\makeDepartmentInfo{english}{food}{tex_fodevareinstituttet_uk}{tex_dtu_fdevareinstituttet_a_uk}{tex_dtu_frise}{National Veterinary Institute}{National Food Institute }%
%
...
% not really needed, since the education are Danish-only
...
\makeDepartmentInfo{danish}{compute}{tex_compute_uk}{tex_dtu_compute_a}{tex_dtu_frise}{Institut for Matematik og Computer Science}{DTU Compute}
\makeDepartmentInfo{english}{compute}{tex_compute_uk}{tex_dtu_compute_a_uk}{tex_dtu_frise}{Department of Applied Mathematics and Computer Science}{DTU Compute}